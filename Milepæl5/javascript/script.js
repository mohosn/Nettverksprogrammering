...
getAllPoem = ()=>{
    ...
    fetch("http://localhost:8180/poem",{
        ...
        //console.log(res); // extracting Poem 
        const poem=res.split(/\r?\n/); //making array of each poem
        //console.log(poem)

        for(let i=0;i<poem.length;i++){
            //console.log(poem[i])
            let poem=extractXMLData(poem[i],'<Poem>','</Poem>');
            //console.log(poem);
...
getAllOwnPoem = ()=>{
    ...
    fetch("http://localhost:8180/poem/own",{
        method: 'GET',
...
deleteAllPoem = ()=>{
    ...
    fetch(`http://localhost:8180/deleteall`, {
        ...
        alert("All of your poem are deleted!!!")
    })
}
