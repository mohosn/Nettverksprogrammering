...
#sudo dockerd --userns-remap=default &      Start the Docker Daemon with user namespace support enabled.
#sudo docker info                           Use the docker info command to verify that user namespace support is properly enabled.
